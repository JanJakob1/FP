...
jitter = 0.     # width of the normal distribution in ms
deltat = 100.   # time till the next example in ms
I2Yw = 8        # input to y_i weight
Y2Hw = 1        # weight from y_i to h_i (excitatory)
Y2Hi = 6       # weight from y_i to h_j (inhibitory)
...
vlabel = 'h1'   # record membrane of this neuron
                # -> use to determine appropriate weights
skip_if_unreliable_list = []    # if you enter a label here a dummy population
...
plt.savefig('XOR/tests/xor_I2Yw = '+str(I2Yw)+'_Y2Hw = '+str(Y2Hw)+'_Y2Hi = '+str(Y2Hi)+'_H2Ow = '+str(H2Ow)+'_.png')
plt.show()
