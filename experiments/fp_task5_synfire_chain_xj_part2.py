...
exc = 10
inh = 10
popSize = {'exc': exc, 'inh': inh}  # size of each chain link
noPops = 192 / (exc + inh)         # chain length
print(noPops)
...
# esc = inh =10 :  2,2,2,1,15
# esc = inh = 6 : 10,10,3,2,15
# esc = inh = 5 : 10,10,3,2,15
# esc = inh = 4 : 10,10,4,2,15
# esc = inh = 3 : 12,12,6,2,15
# esc = inh = 2 : 12,10,10,2,10
# esc=2 inh = 1 : 14,12,12,4,10
...
#plt.show()
#plt.savefig('FeedForwardNetworks/loop.png')
#plt.savefig('FeedForwardNetworks/part2/chainlength_'+str(noPops)+'.png')
#plt.savefig('FeedForwardNetworks/part2/chainlength_'+str(noPops)+'.pdf')
